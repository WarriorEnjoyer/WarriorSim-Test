var talents = [
   {
      ...
      t: [
         ...
         },
         {
            ...
            d: [
               'Axe: +1% crit. Mace: Ignores 1.2 armor per level. Sword: 1% extra attack. Polearm: +0.4 yd range.',
               'Axe: +2% crit. Mace: Ignores 2.4 armor per level. Sword: 2% extra attack. Polearm: +0.8 yd range.',
               'Axe: +3% crit. Mace: Ignores 3.6 armor per level. Sword: 3% extra attack. Polearm: +1.2 yd range.',
               'Axe: +4% crit. Mace: Ignores 4.8 armor per level. Sword: 4% extra attack. Polearm: +1.6 yd range.',
               'Axe: +5% crit. Mace: Ignores 6.0 armor per level. Sword: 5% extra attack. Polearm: +2.0 yd range.'
            ],
            r: [
               6,
               1
         ...
         },
         {
            ...
            d: [
               'Increases the damage done per extra rage point spent on Execute by 25%.',
               'Increases the damage done per extra rage point spent on Execute by 50%.',
               'Increases the damage done per extra rage point spent on Execute by 75%.'
            ],
            x: 2,
            y: 5,
            c: 0,
            iconname: 'ability_hunter_swiftstrike',
            aura: function (count) { return { preccut181: count * 25 } },
         },
         {
            i: 134,
   ...
   },
   {
      ...
      t: [
         ...
         },
         {
            ...
            d: [
               'Reduces the cooldown of Whirlwind by 1 sec and rage cost of Cleave by 1.',
               'Reduces the cooldown of Whirlwind by 1.5 sec and rage cost of Cleave by 2.',
               'Reduces the cooldown of Whirlwind by 2 sec and rage cost of Cleave by 3.',
            ],
            x: 0,
            y: 4,
            c: 0,
            iconname: 'ability_whirlwind',
            aura: function (count) { return { impwhirlwind: count, cleavecost: count } },
         },
         {
            i: 165,
            n: 'Death Wish',
   ...
   },
   {
      ...
      t: [
         ...
         },
         {
            ...
            d: [
               'Increases the threat generated by your attacks by 4% while in Defensive Stance.',
               'Increases the threat generated by your attacks by 8% while in Defensive Stance.',
               ...
               'Increases the threat generated by your attacks by 20% while in Defensive Stance.'
            ],
            x: 2,
            y: 3,
            c: 0,
            iconname: 'Ability_Warrior_InnerRage',
            aura: function (count) { var values = [0, 4, 8, 12, 15, 20]; return { threatmod: values[count] } },
         },
         {
            i: 702,
